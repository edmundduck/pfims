...
class ReportSearchPanelFrom(ReportSearchPanelFromTemplate):
    ...
    def _upd_scr_enablement(self):
        ...
        if interval in (None, ''):
            ...
            if interval != "SDR":
                ...
                self.dropdown_symbol.items = anvil.server.call('get_symbol_dropdown_items', userid=self.userid,
                ...
                self.dropdown_symbol.items = anvil.server.call('get_symbol_dropdown_items', self.userid, self.time_datefrom.date, self.time_dateto.date)
    ...
    def button_tranx_search_click(self, **event_args):
        ...
        self.subform.rpt_panel.items = anvil.server.call('select_journals', self.userid, startdate, enddate, symbol_list)
    ...
    def button_tranx_gen_csv_click(self, **event_args):
        ...
        # Get data from db
        csv_file = anvil.server.call('generate_csv', self.userid, startdate, enddate, symbol_list)
    ...
    def button_pnl_search_click(self, **event_args):
        ...
        self.subform.rpt_panel.items = anvil.server.call('generate_init_pnl_list', userid, startdate, enddate, symbol_list)
